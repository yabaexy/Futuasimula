...
export const ISO_COUNTRIES: CountryConfig[] = [
  ...
  // Blocked Countries (Sanctioned, restricted, EU member states, and Switzerland)
  ...
  { code: '+41', name: 'Switzerland', flag: '🇨🇭', isBlocked: true },
  
  // EU Member States (Blocked)
  { code: '+49', name: 'Germany', flag: '🇩🇪', isBlocked: true },
  { code: '+33', name: 'France', flag: '🇫🇷', isBlocked: true },
  { code: '+46', name: 'Sweden', flag: '🇸🇪', isBlocked: true },
  { code: '+358', name: 'Finland', flag: '🇫🇮', isBlocked: true },
  { code: '+45', name: 'Denmark', flag: '🇩🇰', isBlocked: true },
  { code: '+39', name: 'Italy', flag: '🇮🇹', isBlocked: true },
  { code: '+34', name: 'Spain', flag: '🇪🇸', isBlocked: true },
  { code: '+31', name: 'Netherlands', flag: '🇳🇱', isBlocked: true },
  { code: '+32', name: 'Belgium', flag: '🇧🇪', isBlocked: true },
  { code: '+48', name: 'Poland', flag: '🇵🇱', isBlocked: true },
  { code: '+353', name: 'Ireland', flag: '🇮🇪', isBlocked: true },
  { code: '+43', name: 'Austria', flag: '🇦🇹', isBlocked: true },
  { code: '+351', name: 'Portugal', flag: '🇵🇹', isBlocked: true },
  { code: '+30', name: 'Greece', flag: '🇬🇷', isBlocked: true },
  { code: '+420', name: 'Czech Republic', flag: '🇨🇿', isBlocked: true },
  { code: '+36', name: 'Hungary', flag: '🇭🇺', isBlocked: true },
  { code: '+40', name: 'Romania', flag: '🇷🇴', isBlocked: true },
  { code: '+421', name: 'Slovakia', flag: '🇸🇰', isBlocked: true },
  { code: '+385', name: 'Croatia', flag: '🇭🇷', isBlocked: true },
  { code: '+370', name: 'Lithuania', flag: '🇱🇹', isBlocked: true },
  { code: '+386', name: 'Slovenia', flag: '🇸🇮', isBlocked: true },
  { code: '+371', name: 'Latvia', flag: '🇱🇻', isBlocked: true },
  { code: '+372', name: 'Estonia', flag: '🇪🇪', isBlocked: true },
  { code: '+357', name: 'Cyprus', flag: '🇨🇾', isBlocked: true },
  { code: '+352', name: 'Luxembourg', flag: '🇱🇺', isBlocked: true },
  { code: '+356', name: 'Malta', flag: '🇲🇹', isBlocked: true },
  { code: '+359', name: 'Bulgaria', flag: '🇧🇬', isBlocked: true },
];
